...
import { addNewFavoriteAction } from '../../../store/jokes/actions';
...
const Card = ({ joke }) => {
  ...
  const handleLike = () => {
    if (isFavorite) {
      ...
      dispatch(addNewFavoriteAction(joke));
    }
  };
  ...
  return (
    <li className="card__item" id={joke.id}>
      ...
      <div className="card-btn__wrap">
        ...
        <div className="card__content">
          ...
          <p className={classNames('card__text', { favorite: isFavorite })}>
            {joke.value}
          </p>
        ...
        <div>{/* <img src={joke.icon_url} alt="img" /> */}</div>
      </div>
    </li>
  );
};
